...
<!-- 					<div class="filter-button-tooltip">Click to expand sidebar with filters!</div> -->
			...
			<div class="full-page-job-listings-container">
				...
				<?php
					...
					echo do_shortcode('[jobs orderby="' . $orderby . '" order="' . $order . '"  selected_region="'. get_query_var('job_listing_region') .'"  show_filters="false"]'); ?>
		...
		<div class="full-page-content-container" data-simplebar>
			<div class="full-page-content-inner">
				...
				<div class="listings-container">
					...
					<?php echo do_shortcode('[jobs selected_region="'. get_query_var('job_listing_region') .'"  show_filters="false"]'); ?>
