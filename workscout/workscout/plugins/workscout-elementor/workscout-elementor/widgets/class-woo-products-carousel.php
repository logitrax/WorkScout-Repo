 ...
 * @since 1.0.0
 */
class WooProductsCarousel extends Widget_Base
{
	...
	{
		return 'workscout-woocommerce-products-carousel';
	}
	...
	{
		return __('Workscout Products Carousel', 'workscout_elementor');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'limit',
			[
				'label' => __('Products to display', 'workscout_elementor'),
		...
		$this->add_control(
			'product_types',
			[
				'label' => esc_html__('Product Types', 'workscout_elementor'),
				'placeholder' => esc_html__('Choose Products to Include', 'workscout_elementor'),
				'type' => \Elementor\Controls_Manager::SELECT2,
				'label_block' => true,
				'multiple' => true,
				'default' => '',
		...
		$this->add_control(
			'exclude_posts',
			[
				'label' => __('Exclude Products', 'workscout_elementor'),
				'type' => Controls_Manager::SELECT2,
				'label_block' => true,
				'multiple' => true,
				'default' => [],
		...
		$this->add_control(
			'include_posts',
			[
				'label' => __('Include Products', 'workscout_elementor'),
				'type' => Controls_Manager::SELECT2,
				'label_block' => true,
				'multiple' => true,
				'default' => [],
	...
	protected function render()
	{
		...
		if ($settings['fullwidth']) { ?>
			<!-- Carousel / Start -->
			<div data-slides="6" class="simple-fw-slick-carousel workscout-products-slider  dots-nav" <?php if ($settings['autoplay'] == 'yes') { ?> data-slick='{"autoplay": true, "autoplaySpeed": <?php echo $settings['autoplayspeed']; ?>}' <?php } ?>>
			<?php } else { ?>
				<!-- Carousel / Start -->
				<div data-slides="4" class="simple-slick-carousel  workscout-products-slider dots-nav" <?php if ($settings['autoplay'] == 'yes') { ?> data-slick='{"autoplay": true, "autoplaySpeed": <?php echo $settings['autoplayspeed']; ?>}' <?php } ?>>
					<?php }
				if ($products) {
					$count = 0;
						...
						<div class="fw-carousel-item">
							...
							<div <?php post_class('', $product->get_id()); ?>>
								<div class="mediaholder">
									...
									$label 	= apply_filters('add_to_cart_text', esc_html__('Add to cart', 'workscout_elementor'));
									?>
