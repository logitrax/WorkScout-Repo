...
class HomeSearchSlider extends Widget_Base
{
	...
	{
		return 'workscout-homesearch-slider';
	}
	...
	{
		return __('Home Search Slider Form', 'workscout_elementor');
	}
	...
	protected function register_controls()
	{
		...
		$repeater->add_control(
			'image',
			[
				'label' => __('Choose Slider Image', 'workscout_elementor'),
				'label_block' => true,
				'type' => \Elementor\Controls_Manager::MEDIA,
				'default' => [
		...
		<div class="main-search-photo-slider">
			<div class="msps-slider-container">
				<div class="msps-slider">
					...
					<?php foreach ($settings['list'] as $value) {

					?>
						<div class="item"><img src="<?php echo $value['image']['url'] ?>" class="item" title="Title 1" /></div>
					<?php } ?>
