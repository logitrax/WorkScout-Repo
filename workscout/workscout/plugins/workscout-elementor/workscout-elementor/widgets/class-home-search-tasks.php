 ...
 * @since 1.0.0
 */
class HomeSearchTasks extends Widget_Base
{
    ...
    {
        return 'workscout-homesearch-tasks';
    }
    ...
    {
        return __('Home Search Tasks Form', 'workscout_elementor');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => __('Find Tasks', 'workscout_elementor'),
            )
        );
        $this->add_control(
            'subtitle',
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'    => \Elementor\Controls_Manager::TEXT,
                'default' => __('What task are you looking for?', 'workscout_elementor'),
                'label_block' => true,
                'condition' => [
                    'searchform' => 'keyword'
                ],
        ...
        $this->add_control(
            ...
            array(
                ...
                'label_block' => true,
                'type'    => \Elementor\Controls_Manager::TEXT,
                'default' => __('Search tasks', 'workscout_elementor'),
                'condition' => [
                    'searchform' => 'keyword'
                ],
            )
