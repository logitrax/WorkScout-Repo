 ...
 * @since 1.0.0
 */
class HomeSearch extends Widget_Base
{
    ...
    {
        return __('Home Search Jobs Form', 'workscout_elementor');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'white_space',
            [
                'label' => __('Extra White Space around', 'workscout_elementor'),

                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Enable', 'workscout_elementor'),
                'label_off' => __(
                    'Disable',
                    'workscout_elementor'
                ),
        ...
        $this->add_control(
            'padding',
            [
                'label' => esc_html__('Space around form', 'plugin-name'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .intro-banner' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
...
?>
        ...
        <!-- Intro Banner
    ================================================== -->
        <div class="intro-banner dark-overlay <?php if ($settings['white_space'] == 'yes') {
                                                    echo "extra-white-space";
                                                } ?>" <?php if ($settings['new_background_image'] == null) { 
                                                    $image_id = $settings['background']['id'];
                                                    $image_url = wp_get_attachment_image_url($image_id, 'full');
                                                    ?>data-background-image="<?php echo esc_url($image_url); ?>" <?php } ?>>
