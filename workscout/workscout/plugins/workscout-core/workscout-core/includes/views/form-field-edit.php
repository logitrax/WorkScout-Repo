...
<div class="edit-form-field" style="display: none;">
	...
	<div id="workscout-field-<?php echo $field_key; ?>">
		...
		<p class="field-icon">
			<label for="icon"><?php esc_html_e('Category Icon', 'workscout_core'); ?></label>
			<select class="workscout-icon-select" name="icon[<?php echo esc_attr($index); ?>]" id="icon">
		...
		<p class="workscout-editor-placeholder-field">
		...
		<p class="workscout-editor-css-field">
		...
		<p class="workscout-editor-width-field">
