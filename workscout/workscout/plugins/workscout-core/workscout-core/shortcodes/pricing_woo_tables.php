                ...
                <div class="plan-features">
                    <ul>
                        ...
                        if(!$jobslimit){
                            ...
                            <li>
                                <?php esc_html_e('This plan includes ','workscout_core'); 
                                printf( _n( '%d job', '%s jobs', $jobslimit, 'workscout' ) . ' ', $jobslimit ); ?>
                            </li>
                        <?php } ?>
                        <li>
                            <?php  printf( _n( 'Job is posted', 'Jobs are posted', $jobslimit, 'workscout' ) . ' ', $jobslimit );  printf( _n( 'for %s day', 'for %s days', $job_package->get_duration(), 'workscout_core' ), $job_package->get_duration() ); ?>
                        </li>
