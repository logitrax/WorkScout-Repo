...
// $('.workscout_map_settings').hide();
// $('.workscout_map_settings.map_provider').cha();
$('.workscout_map_settings.map_provider input[type=radio]').on('change', function() {
     switch($(this).val()) {
         case 'osm':
             	$('.workscout_map_settings.maps_api').hide();
             	$('.workscout_map_settings.mapbox_access_token').hide();
             	$('.workscout_map_settings.mapbox_retina').hide();
				$('.workscout_map_settings.bing_maps_key').hide();
				$('.workscout_map_settings.thunderforest_api_key').hide();
				$('.workscout_map_settings.here_app_id').hide();
             	$('.workscout_map_settings.here_app_code').hide();
             break;
         case 'google':
	            $('.workscout_map_settings.maps_api').show();
             	$('.workscout_map_settings.mapbox_access_token').hide();
				$('.workscout_map_settings.bing_maps_key').hide();
				$('.workscout_map_settings.mapbox_retina').hide();
				$('.workscout_map_settings.thunderforest_api_key').hide();
             ...
             break;
         case 'mapbox':
             $('.workscout_map_settings.mapbox_access_token').show();
             $('.workscout_map_settings.mapbox_retina').show();
             $('.workscout_map_settings.maps_api').hide();
             ...
             break;         
        case 'bing':
             	$('.workscout_map_settings.bing_maps_key').show();
             	$('.workscout_map_settings.maps_api').hide();
             	$('.workscout_map_settings.mapbox_retina').hide();
             	$('.workscout_map_settings.mapbox_access_token').hide();
				$('.workscout_map_settings.thunderforest_api_key').hide();
             ...
             break;       
        case 'thunderforest':
             	$('.workscout_map_settings.thunderforest_api_key').show();
             	$('.workscout_map_settings.maps_api').hide();
             	$('.workscout_map_settings.mapbox_retina').hide();
             	$('.workscout_map_settings.mapbox_access_token').hide();
				$('.workscout_map_settings.bing_maps_key').hide();
             ...
             break;        
        case 'here':
             	$('.workscout_map_settings.here_app_id').show();
             	$('.workscout_map_settings.here_app_code').show();
             	$('.workscout_map_settings.maps_api').hide();
             	$('.workscout_map_settings.mapbox_retina').hide();
             	$('.workscout_map_settings.mapbox_access_token').hide();
				$('.workscout_map_settings.bing_maps_key').hide();
...
$('.workscout_map_settings.map_provider input[type=radio]:checked').trigger('change');

    $('.cmb2-id--task-deadline input').datepicker({
      dateFormat: "yy-mm-dd",
    });
