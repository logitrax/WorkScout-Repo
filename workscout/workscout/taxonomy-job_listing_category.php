		...
		<div class="full-page-content-container">
			...
			<div class="full-page-content-inner">
				...
				<div class="full-page-job-listings-container">
					...
					echo do_shortcode('[jobs orderby="' . $orderby . '" order="' . $order . '" categories=' . get_query_var('job_listing_category') . ' show_filters="false"]'); ?>
	...
	if (!empty($header_image)) { ?>
		...
		<?php } else { ?>
			...
			<div class="container  wpjm-container <?php echo esc_attr($layout); ?>">
				...
				<article id="post-<?php echo $t_id; ?>" <?php post_class('eleven columns'); ?>>
