...
$regions = get_the_terms($post->ID, 'job_listing_region');
...
$region = wp_list_pluck($regions, 'term_id');
...
//show only company
if (!empty($company) && in_array('company', $related_type)) {
...
//show same category
if (in_array('region', $related_type)) {
    $related_args['tax_query'] = array(
        array(
            ...
            <?php while ($wp_query->have_posts()) :
                ...
                <?php } ?>
                    ...
                    <?php if (in_array("location", $job_meta)) { ?>
                        <span class="ws-meta-job-location"><?php echo workscout_get_icon('location'); ?> <?php ws_job_location(); ?></span>
                    <?php } ?>
