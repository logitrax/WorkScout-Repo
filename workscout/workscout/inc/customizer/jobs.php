...
Kirki::add_field( 'workscout', array(
	    ...
	    'choices'     => array(
	        ...
	        'split_job_view'		=> __( 'Split page with job view on right', 'workscout' ),
...
Kirki::add_field( 'workscout', array(
	    'type'        => 'select',
	    'settings'    => 'jobs_listings_list_layout',
	    'label'       => esc_html__( 'Jobs list layout', 'workscout' ),
	    'section'     => 'jobs_list',
	    'description' => '',
	    'default'     => 'list',
	    'priority'    => 10,
...
Kirki::add_field( 'workscout', array(
	...
	Kirki::add_field( 'workscout', array(
	    ...
	    'choices'     => array(
			...
			'wpjm_salary' 				=> esc_html__('WP Job Manager Salary field', 'workscout'),
...
Kirki::add_section( 'jobs', array(
	...
	Kirki::add_field( 'workscout', array(
	    ...
	    'label'       => esc_html__( 'Single Job Sidebar side', 'workscout' ),
	...
	// Kirki::add_field( 'workscout', array(
	//     'type'        => 'radio',
	//     'settings'     => 'pp_job_style',
	//     'label'       => esc_html__( 'Single Job style', 'workscout' ),
	//     'description' => esc_html__( 'Choose the style for job lis side for single job', 'workscout' ),
	//     'section'     => 'jobs',
	//     'default'     => 'classic',
	//     'priority'    => 10,
	//     'choices'     => array(
	//         'modern' => esc_html__( 'Modern', 'workscout' ),
	//         'classic' => esc_html__( 'Classic', 'workscout' ),
	//     ),
	// ) );
...
Kirki::add_field('workscout', array(
	'type'        => 'multicheck',
	'settings'     => 'pp_related_jobs_type',
	'label'       => esc_html__('Show related jobs based on', 'workscout'),
	'description' => esc_html__('Set how jobs will be related', 'workscout'),
	'section'     => 'jobs',
	'default'     => array(),
	'priority'    => 10,
	'choices'     => array(
		'category' 	=> esc_html__('Same Category', 'workscout'),
		'company' 		=> esc_html__('Same Company', 'workscout'),
		'region' 		=> esc_html__('Same Region', 'workscout'),
